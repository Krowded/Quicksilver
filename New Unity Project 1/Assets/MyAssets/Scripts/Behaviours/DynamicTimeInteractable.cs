...
public class DynamicTimeInteractable : TimeInteractable {
	...
	protected List<FrameState> states = new List<FrameState>(); //FIXME: Probably wanna preallocate this
	...
	public override void SlowTime(int slowFactor) {
		ResetState ();
	...
	protected virtual void StoreState(int numberOfStates = 1) {
