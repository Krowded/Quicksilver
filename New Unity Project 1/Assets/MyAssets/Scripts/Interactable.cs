...
public abstract class Interactable : MonoBehaviour
{
	...
	public virtual void DropAndReset() {
		Drop ();
	}
	...
	private void TurnGravityOff() {
		rb = gameObject.GetComponent<Rigidbody> (); //Regetting the rigidbody every time here, just to avoid bugs if it gains one while grabbed up
		if (rb != null) {
